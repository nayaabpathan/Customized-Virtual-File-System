...
void man(char *name)
{
  ...
  {
    printf("Description : Used to list all the infromation of files \n");
    printf("Usage       : ls\n");
  }
  else if(strcmp(name,"stat")==0)
  {
    printf("Description : Used to display information of file using file name \n");
  ...
  {
    printf("Description : Used to remove the data of regular file \n");
  ...
  {
    printf("Description : Used to close a existing opened file \n");
  ...
  {
    printf("Description : Used to open a existing file \n");
    printf("Usage       : close File_name\n");
  ...
  {
    printf("ERORR : No Mannual Entry available\n");
  }
...
int main()
{
    ...
    else if(count == 2)
   {
    ...
    else if(strcmp(command[0],"write")==0)
    {
        ...
        if(ret==0)
        {
            printf("ERORR : Incorrect Parameters\n");
            continue;
        }
